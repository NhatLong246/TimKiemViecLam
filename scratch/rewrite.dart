...
void main() {
  final file = File('e:/BTL_Android/TimKiemViecLam/lib/screens/job/job_detail_screen.dart');
  ...
  final code = lines.sublist(0, buildIdx).join('\n') + '\n';

  final newCode = '''  @override
