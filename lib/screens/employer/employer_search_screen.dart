          ...
          builder: (ctx2, usersSnap) {
            ...
            return GridView.builder(
              ...
              itemBuilder: (_, i) => _WorkerCard(
                worker: filtered[i].worker,
                criteria: filtered[i].criteria,
                query: query,
              ),
            );
          },
...
class _WorkerCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final user = worker.userModel;
    final name = worker.name.isEmpty ? 'Người làm' : worker.name;
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: Text(
                    criteria?.position.isNotEmpty == true
                        ? criteria!.position
