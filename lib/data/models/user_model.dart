...
class UserModel {
  ...
  final String?
  avatarBase64; // ảnh đại diện dạng Base64 (thay thế Firebase Storage)
  final String? gender;
  ...
  final List<String> taxCodeImageUrls;
  final List<String> otherDocumentImageUrls;
  ...
  const UserModel({
    ...
    this.businessLicenseImageUrls = const [],
    this.taxCodeImageUrls = const [],
    this.otherDocumentImageUrls = const [],
  ...
  UserModel copyWith({
    ...
    List<String>? taxCodeImageUrls,
    List<String>? otherDocumentImageUrls,
    ...
    return UserModel(
      ...
      taxCodeImageUrls: taxCodeImageUrls ?? this.taxCodeImageUrls,
      otherDocumentImageUrls:
          otherDocumentImageUrls ?? this.otherDocumentImageUrls,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'taxCodeImageUrls': taxCodeImageUrls,
      'otherDocumentImageUrls': otherDocumentImageUrls,
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    return UserModel(
      ...
      businessLicenseImageUrls: _parseStringList(
        map['businessLicenseImageUrls'],
      ),
      taxCodeImageUrls: _parseStringList(map['taxCodeImageUrls']),
      otherDocumentImageUrls: _parseStringList(map['otherDocumentImageUrls']),
